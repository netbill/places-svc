...
const (
	...
	PlaceClassIDField   = "place_class_id"
...
func (l *Logger) WithPlace(place models.Place) *Logger {
	return &Logger{base: l.base.With(
		slog.String(PlaceClassIDField, place.ID.String()),
		slog.String(OrganizationIDField, place.OrganizationID.String()),
	)}
}
